    ...
    'DST_denormalized': {
        ...
        'columns': [
            ...
            {'name': 'category',                    'alias': 'category',
                'transform': 'category_to_title_case', 'faceted': True, },
            {'name': 'purpose_detail',              'alias': 'description'},
            {'name': 'collection',                  'alias': 'collections',
                'transform': 'collections_to_title_case', 'faceted': True, },
            {'name': 'has_application',
                'alias': 'AIApplicationJSON', 'columnType': 'JSON'},
            {'name': 'has_application',             'alias': 'aiApplicationCount',
                'transform': 'json_to_count', 'columnType': 'INTEGER'},
            {'name': 'has_application',             'alias': 'hasAIApplication',
                'transform': 'count_to_yes_no', 'columnType': 'STRING', 'faceted': True, },
            {'name': 'has_application',             'alias': 'applicationNames',
                'transform': 'json_to_name_strings', 'columnType': 'STRING_LIST', 'faceted': True, },
            {'name': ['id', 'has_application'],     'alias': 'aiAppMarkdown',
                'transform': 'ai_app_to_markdown', 'columnType': 'STRING'},
            {'name': 'collection',                  'alias': 'mature',
                'transform': 'collections_to_is_mature', 'columnType': 'STRING', 'faceted': True, },
            ...
            {'name': 'is_open',                     'alias': 'isOpen',
                'transform': 'bool_to_yes_no', 'columnType': 'STRING', 'faceted': True, },
            {'name': 'requires_registration',       'alias': 'registration',
                'transform': 'bool_to_yes_no', 'columnType': 'STRING', 'faceted': True, },
            {'name': 'url',                         'alias': 'URL'},
            {'name': 'formal_specification',        'alias': 'formalSpec'},
            {'name': 'publication',
                'alias': 'publication', 'columnType': 'JSON'},
            ...
            {'name': 'used_in_bridge2ai',           'alias': 'usedInBridge2AI',
                'transform': 'bool_to_yes_no', 'columnType': 'STRING', 'faceted': True, },
        ],
        'join_columns': [
            ...
            {'join_tbl': 'Organization', 'base_tbl_col': 'has_relevant_organization', 'join_tbl_col': 'id',
             'dest_cols': [
                 {'faceted': True,  'name': 'description',
                     'alias': 'relevantOrgNames'},
                 {'source_cols': [
                     'id', 'name'], 'alias': 'relevantOrgLinks', 'transform': 'create_org_link', },
             ]},
            ...
            {'join_tbl': 'DataSet_denormalized', 'base_tbl_col': 'responsible_organization', 'join_tbl_col': 'producedByOrgId',
             'dest_cols': [
                 {'name': 'description', 'alias': 'responsibleOrgDatasetDescriptions',
                     'columnType': 'LARGETEXT'},
                 {'name': 'topics', 'alias': 'responsibleOrgDatasetTopics',
                  'columnType': 'LARGETEXT'},
             ]},
            {'join_tbl': 'DataSet_denormalized', 'base_tbl_col': 'has_relevant_organization', 'join_tbl_col': 'producedByOrgId',
             'dest_cols': [
                 {'name': 'description', 'alias': 'relevantOrgDatasetDescriptions',
                     'columnType': 'LARGETEXT'},
                 {'name': 'topics', 'alias': 'relevantOrgDatasetTopics',
                  'columnType': 'LARGETEXT'},
             ]},
        ],
    },
    ...
    'DataSet_denormalized': {
        ...
        'columns': [
            ...
            {'faceted': True, 'name': 'category', 'alias': 'category',
                'transform': 'category_to_title_case'},
        ...
        'join_columns': [
            ...
            {'join_tbl': 'DataSubstrate', 'base_tbl_col': 'substrates', 'join_tbl_col': 'id',
             'dest_cols': [
                 ...
                 {'name': 'substrates_json', 'alias': 'substrates_json',
                     'whole_records': True, }
             ]},
        ],
    },
