...
DEST_TABLES = {
    ...
    'DST_denormalized': {
        ...
        'columns': [
            ...
            {'name': ['id', 'has_application'],     'alias': 'aiAppMarkdown', 'transform': 'ai_app_to_markdown', 'columnType': 'STRING'},
        ...
        'join_columns': [
            ...
            {'join_tbl': 'Organization', 'base_tbl_col': 'responsible_organization', 'join_tbl_col': 'id',
             'dest_cols': [
                 ...
                 {'source_cols': ['id', 'name'], 'alias': 'responsibleOrgLinks', 'transform': 'create_org_link', },
             ]},
    ...
    'DataSet_denormalized': {
        ...
        'columns': [
            ...
            {'name': 'name', 'alias': 'name'},
            {'name': 'description', 'alias': 'description'},
            {'name': 'category', 'faceted': True, 'alias': 'category', 'transform': 'category_to_title_case'},
