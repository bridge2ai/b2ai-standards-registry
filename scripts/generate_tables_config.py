...
DEST_TABLES = {
    ...
    'DST_denormalized': {
        ...
        'columns': [
            ...
            {'faceted': True,  'name': 'category',
                'alias': 'category', 'transform': 'category_to_title_case'},
            {'name': 'purpose_detail',              'alias': 'description'},
            {'faceted': True,  'name': 'collection',
                'alias': 'collections', 'transform': 'collections_to_title_case'},
            {'faceted': True,  'name': 'collection',                  'alias': 'hasAIApplication',
                'transform': 'collections_to_has_ai_app', 'columnType': 'STRING'},
            {'faceted': True,  'name': 'collection',                  'alias': 'mature',
                'transform': 'collections_to_is_mature', 'columnType': 'STRING'},
            ...
            {'faceted': True,  'name': 'is_open',                     'alias': 'isOpen',
                'transform': 'bool_to_yes_no', 'columnType': 'STRING'},
            ...
            {'faceted': True,  'name': 'used_in_bridge2ai',           'alias': 'usedInBridge2AI',
                'transform': 'bool_to_yes_no', 'columnType': 'STRING'},
        ],
        'join_columns': [
