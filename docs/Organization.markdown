...
| Full Name | Short Name | ID | Data Documentation | RO-Crate Package |
|-----------|------------|----|--------------------|------------------|
...
RO-Crate packages are properties of the data sets themselves, not of the organizations producing them, so their links are stored in the `ro_crate_url` slot of the corresponding DataSet entry. Each Grand Challenge's packages are listed above for convenience, and appear alongside the data set they belong to in the Explorer.
