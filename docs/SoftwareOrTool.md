...
URI: [STANDARDSDATASTANDARDORTOOL:SoftwareOrTool](https://w3id.org/bridge2ai/standards-datastandardortool-schema/SoftwareOrTool)
...
| ---  | ---  |
| self | STANDARDSDATASTANDARDORTOOL:SoftwareOrTool |
| native | STANDARDSDATASTANDARDORTOOL:SoftwareOrTool |
